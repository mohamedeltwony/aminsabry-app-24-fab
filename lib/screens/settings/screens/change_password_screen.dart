                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: Icon(oldPasswordVisible ? Icons.visibility_off : Icons.visibility, color: colorPrimary).onTap(() {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(borderSide: BorderSide(color: colorPrimary)),
                        enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.grey.shade500)),
                        suffixIcon: Icon(newPasswordVisible ? Icons.visibility_off : Icons.visibility, color: colorPrimary).onTap(() {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(borderSide: BorderSide(color: colorPrimary)),
                        enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.grey.shade500)),
                        suffixIcon: Icon(confPasswordVisible ? Icons.visibility_off : Icons.visibility, color: colorPrimary).onTap(() {
